window.onload = function(){
	for (var i=0; i<9; i++) {
		document.getElementById('game').innerHTML+='<div class="block"></div>'; <!-- создание сетки зхз -->
	}

	var hod = 0;

	document.getElementById('game').onclick = function(event){ //захват клика по всему блоку
		console.log(event);
